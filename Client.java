...
public class Client implements ActionListener{
    ...
    Client(){
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("chatting/application/icons/woman.png"));
        Image i5 = i4.getImage().getScaledInstance(60, 60, Image.SCALE_DEFAULT);
        ImageIcon i6 = new ImageIcon(i5);
        JLabel l2 = new JLabel(i6);
        l2.setBounds(36, 10, 60, 60);
        p1.add(l2);
        ...
        l7.setBounds(405, 23, 13, 25);
        p1.add(l7);
        
        JLabel l3 = new JLabel("Christine");
